...
/**
 * Class Scoreboard - write a description of the class here
 * 
 * @author (your name) 
 * @version (a version number)
 */
public class Scoreboard extends Applet implements MouseListener, 
MouseWheelListener, ActionListener, MouseMotionListener
{
    ...
    public void paint(Graphics g)
    {
        ...
        for(int i = 0; i < l.Players.size(); i++){
            ...
            g.drawString(l.Players.get(i) + ": " + l.scores[i], 110, loc+5);
            loc = loc + 50;
        }
        //g.drawImage(transfer, 20, loc-20, this);
        //g.drawImage(plus_minus, 100, 100, this);
